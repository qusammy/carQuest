...
struct AuctionCreation: View {
    ...
    @State var date = Date()
    @State var startBid: String
    @State var buyout: String
                ...
                HStack{
                    ...
                    HStack{
                        ...
                        .sheet(isPresented: $previewListing){
                            carQuest.previewListing(carYear: carYear, make: carMake, model: carModel, carDescription: carDescription, typeOfCar: carType, date: date, listingPrice: startBid, listedPhotos: previewImages, isLiked: false)
                        }
                    }
                }
                Divider()
                    ...
                    Group{
                        HStack{
                            ...
                            Text("$")
                                ...
                                .italic()
                                .foregroundColor(Color(red: 0.723, green: 0.717, blue: 0.726))
                            TextField("000.00", text: $startBid)
    ...
    func createListingAuction(listingExists: Bool, listingName: String) async throws {
        ...
        if listingExists == true {
            ...
            listingID = "A\(additionalListing)\(userID)"
...
#Preview {
    AuctionCreation(editListing: false, carType: "", location: "", carModel: "", carMake: "", carDescription: "", startBid: "", buyout: "", endTime: Date(), showSignInView: .constant(false))
}
